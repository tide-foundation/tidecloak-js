...
function Heimdall(config) {
    ...
    kc.signCardanoTx = async function (txBody, authorizers, ruleSettings, expiry) {
        ...
        cardanoSignRequest = new AuthorizationBuilder(cardanoSignRequest, authorizers, ruleSettings).addAuthorization();
    ...
    kc.createRuleSettingsDraft = function (ruleSettings, previousRuleSetting, previousRuleSettingCert) {
        ...
        if(previousRuleSetting !== null && previousRuleSettingDraft !== null) {
    ...
    kc.signRuleSettings = async function (ruleReqDraft, authorizers, ruleSettings, expiry) {
        // Check user authenticated
        if (!kc.tokenParsed) {
            throw 'Not authenticated';
        }
        ...
        ruleSignRequest = new AuthorizationBuilder(ruleSignRequest, authorizers, ruleSettings).addAuthorization();
